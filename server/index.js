...
server.listen({
  // APOLLO_PORT only, validated in constants.js. There is deliberately no `PORT` fallback: this
  // project runs two servers and a shared PORT collided between them.
  port
}).then(
  (serverInformation) =>
    console.log(
